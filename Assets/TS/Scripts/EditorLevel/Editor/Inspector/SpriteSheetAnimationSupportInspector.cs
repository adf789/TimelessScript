...
{
    private SpriteSheetAnimationSupport inspectorTarget = null;
    ...
    private SpriteSheetAnimationSupport util = null;
    private int count = 0;
    ...
    public override void OnInspectorGUI()
    {
        try
        {
            if (util == null)
            {
                util = target as SpriteSheetAnimationSupport;
            ...
            else if (count > util.spriteSheets.Count)
            {
                ...
                while (count > util.spriteSheets.Count)
                {
                    util.spriteSheets.Add(new SpriteSheetAnimationSupport.SpriteSheetNode());
                    ...
                    if (GUILayout.Button("+", GUILayout.Width(22)))
                    {
                        if (util.spriteSheets.Count < int.MaxValue)
                        {
                            if (util.spriteSheets.Count == 0)
                                ...
                                util.spriteSheets.Add(new SpriteSheetAnimationSupport.SpriteSheetNode(util.spriteSheets[util.spriteSheets.Count - 1]));
